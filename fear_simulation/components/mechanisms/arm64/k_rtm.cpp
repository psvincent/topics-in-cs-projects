 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 k_rtm /Users/trophv/4001/mini-project-1/CI-BioEng-Class/fear_simulation/components/mechanisms/k_rtm.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/trophv/4001/mini-project-1/CI-BioEng-Class/fear_simulation/components/mechanisms/k_rtm.mod";
